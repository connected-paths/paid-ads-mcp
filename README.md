...
Paid Ads MCP is a hosted MCP server for Google Ads and LinkedIn Ads that lets marketers use ChatGPT, Claude, Cursor, and other MCP-compatible AI clients to analyze paid media performance, review account structure, compare campaigns, surface recommendations, and monitor weekly trends without exporting spreadsheets or switching between ad platforms.
